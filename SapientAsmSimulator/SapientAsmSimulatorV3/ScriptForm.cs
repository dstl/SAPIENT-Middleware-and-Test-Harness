...
// <copyright file="ScriptForm.cs" company="QinetiQ">
    ...
    public partial class ScriptForm : Form
    {
        ...
        private bool HandleResponse(string filename)
        {
            ...
            try
            {
                ...
                if (expectedErrorMessage == null)
                {
                    ...
                    AppendTextBox("Do you need to include an expected response in: " + SapientASMsimulator.Properties.Settings.Default.ExpectedResponseFilePath);
                    AppendTextBox("");
                    return false;
                }
        ...
        private static Dictionary<string, string> BuildListOfExpectedErrors()
        {
            ...
            try
            {
                ...
                var responses = File.ReadLines(SapientASMsimulator.Properties.Settings.Default.ExpectedResponseFilePath);
        ...
        /// <summary>
        /// Send all XML files pertaining to the ASM from the folder specified in settings
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        {
            outputWindow.Clear();
            string[] allfiles = Directory.GetFiles(SapientASMsimulator.Properties.Settings.Default.XMLTestMessagesRoot, "*.txt", SearchOption.AllDirectories);
            xmlList = new List<string>();
            ClearFileList();
            foreach (string file in allfiles)
            {
                //XML files for both the ASM and HLDMM are stored in sibling directories, only want to send ASM ones
